...
order: 12
thumbnail: /assets/images/thumb-eeg-earbud-auth.jpg
thumbnail_webp: /assets/images/thumb-eeg-earbud-auth.webp
thumbnail_alt: "Still from the CAD assembly animation: the earbud shell opens to reveal the sensor electronics and pin contacts packed inside."
---
...
<figure class="figure">
  <video controls loop muted playsinline preload="metadata" poster="{{ '/assets/images/earbud-anim-poster.jpg' | relative_url }}" width="1280" height="720">
    <source src="{{ '/assets/video/earbud.mp4' | relative_url }}" type="video/mp4">
    Your browser can't play this video — <a href="{{ '/assets/video/earbud.mp4' | relative_url }}">download the MP4</a>.
  </video>
  <figcaption>CAD assembly animation of the earbud: the shell opens to reveal the sensor electronics, coin-cell power, and pin contacts packed into an earbud form factor.</figcaption>
</figure>
